...
-(void)setupWeekHeader{
    ...
    for (int i =0; i < count; i++) {
        UILabel * weekdayLable = [[UILabel alloc]initWithFrame:CGRectMake(weekHeaderSetX,5, (DeviceWidth -10) / count, 20)];// y 50
...
//    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(15,74 - 45, DeviceWidth - 30, 1)];
...
-(void)setupScrollView{
    ...
    [self.scrollView setFrame:CGRectMake(0,75 - 45, DeviceWidth, self.centerCalendarItem.frame.size.height)];//75
